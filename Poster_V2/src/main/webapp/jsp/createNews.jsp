    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 ">
                ...
                <form action="/controller?command=createNews" method="post" enctype="multipart/form-data">
                    <div class="row">

                        <div class="well clearfix">
                            <div class="col-lg-3 col-md-2 text-center">

                                Заголовок: <input required type="text" name="newstitle"><br/>
                                <br/>
                                Контент: <textarea required ="100" rows="13" type="text" name="content"></textarea><br/>
                                <br/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-lg-push-7 ">
                                ...
                                <button type="button" class=" btn btn-lg btn-warning pull-right"><a
                                        href="https://www.kinonews.ru/">Kinonews</a></button><br/>
